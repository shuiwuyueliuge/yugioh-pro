package cn.mayu.yugioh.security.core.base.config;
...
import cn.mayu.yugioh.security.core.base.property.EhcacheProperty;
...
public class EhcacheConfig {
    ...
    private CacheManager cacheManager(EhcacheProperty ehcacheProperty) {
        ...
        CacheConfiguration<String, String> configuration = CacheConfigurationBuilder
                ...
                .build();
        return CacheManagerBuilder.newCacheManagerBuilder().withCache(CACHE_NAME, configuration).build(Boolean.TRUE);
    }
