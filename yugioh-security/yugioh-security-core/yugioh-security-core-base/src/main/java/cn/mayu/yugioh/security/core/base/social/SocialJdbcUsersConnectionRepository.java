...
public class SocialJdbcUsersConnectionRepository implements UsersConnectionRepository {
	...
	public SocialJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator,
	...
	public ConnectionRepository createConnectionRepository(String userId) {
		...
		return new SocialJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
	}
